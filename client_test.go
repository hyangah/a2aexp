...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Invoke(context.Background(), a2aexp.InvokeParamsSendMessageRequest{
	...
	if userAgent != fmt.Sprintf("A2aExp/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Invoke(context.Background(), a2aexp.InvokeParamsSendMessageRequest{
		ID: a2aexp.InvokeParamsSendMessageRequestIDUnion{
			OfString: a2aexp.String("string"),
		},
		Jsonrpc: "2.0",
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Invoke(cancelCtx, a2aexp.InvokeParamsSendMessageRequest{
		ID: a2aexp.InvokeParamsSendMessageRequestIDUnion{
			OfString: a2aexp.String("string"),
		},
		Jsonrpc: "2.0",
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Invoke(deadlineCtx, a2aexp.InvokeParamsSendMessageRequest{
			ID: a2aexp.InvokeParamsSendMessageRequestIDUnion{
				OfString: a2aexp.String("string"),
			},
			Jsonrpc: "2.0",
